...
product_category-Furniture = Meubles
product_category-Groceries = Épicerie
product_category-HomeDecoration = Décoration d'intérieur
product_category-KitchenAccessories = Accessoires de cuisine
product_category-Laptops = Ordinateurs portables
product_category-MensShirts = Chemises pour hommes
product_category-MensShoes = Chaussures pour hommes
product_category-MensWatches = Montres pour hommes
product_category-MobileAccessories = Accessoires mobiles
product_category-Motorcycle = Moto
product_category-SkinCare = Soins de la peau
product_category-Smartphones = Smartphones
product_category-SportsAccessories = Accessoires de sport
product_category-Sunglasses = Lunettes de soleil
product_category-Tablets = Tablettes
product_category-Tops = Hauts
product_category-Vehicle = Véhicule
product_category-WomensBags = Sacs pour femmes
product_category-WomensDresses = Robes pour femmes
product_category-WomensJewellery = Bijoux pour femmes
