...
#[doc(hidden)]
pub struct DbUpdate {
    spacetime_event: __sdk::TableUpdate<SpacetimeEvent>,
}
    ...
    fn try_from(raw: __ws::v2::TransactionUpdate) -> Result<Self, Self::Error> {
        ...
        for table_update in __sdk::transaction_update_iter_table_updates(raw) {
            match &table_update.table_name[..] {
                "spacetime_event" => db_update
                    .spacetime_event
                    .append(spacetime_event_table::parse_table_update(table_update)?),
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.spacetime_event =
            cache.apply_diff_to_table::<SpacetimeEvent>("spacetime_event", &self.spacetime_event);
...
pub struct AppliedDiff<'r> {
    spacetime_event: __sdk::TableAppliedDiff<'r, SpacetimeEvent>,
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<SpacetimeEvent>(
            "spacetime_event",
            &self.spacetime_event,
            event,
        );
    }
}
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        spacetime_event_table::register_table(client_cache);
    }
    const ALL_TABLE_NAMES: &'static [&'static str] = &["spacetime_event"];
}
